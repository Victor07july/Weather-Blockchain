...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 5:
        print("É esperado: Placa, combustível, distância e eficiencia energetica")
        exit(1)
    ...
    eficiencia_energetica = float(sys.argv[4])
    
    #shows the meter public key
    print("foram informados:", placa, combustivel, distancia, eficiencia_energetica)
    
    #calcular a eficiencia energetica
    consumo_energetico = float(distancia)/eficiencia_energetica
...
response = loop.run_until_complete(c_hlf.chaincode_invoke(
        ...
        cc_name=cc_name, 
        fcn='Mynum', 
        args=[placa, combustivel, distancia, str(eficiencia_energetica)], 
        cc_pattern=None))
